...
"set",t);f(h+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(h+"require","render");a||(a=!0,N(n,function(){return qh().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var u=V("dataLayer"),v=u&&u.hide;v&&(v.end||!0===v["GTM-P5GCKB"])&&(v[b.vtp_optimizeContainerId]=!0)}else I(b.vtp_gtmOnFailure)})}();
